...
class _FadeAnimationState extends State<FadeAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    scaleAnimation = Tween<double>(begin: begin, end: end).animate(
      CurvedAnimation(parent: _animationController, curve: const Interval(begin, end, curve: Curves.easeInOut)),
    );

    fadeAnimation = Tween<double>(begin: begin, end: end).animate(
      CurvedAnimation(parent: _animationController, curve: const Interval(begin, end, curve: Curves.easeInOut)),
    );
  }
